defmodule TicTacToe.TextGraphicsTest do
  ...
  alias TicTacToe.TextGraphics.{YinYangMarker, CatMarker, OMarker, XMarker, DefaultLabel}
  ...
  describe "tic tac toe board" do
    test "should return a tic tac toe board as a string with no points drawn" do
      ...
      assert {:ok, board_string} = TextGraphics.draw_board(board, markers, DefaultLabel)
      # assert board_string ==
